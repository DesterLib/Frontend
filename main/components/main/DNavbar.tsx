...
import { SearchIconWrapper, SearchInputBase, SearchResults, SearchWrapper, SearchCardContainer } from '../repeat/DSearchBar';
            ...
            <AppBar sx={appBarStyles} elevation={0} position="fixed">
                <Toolbar variant="dense">
                    <IconButton
                        ...
                        color="inherit"
                        aria-label="menu"
                        sx={{ padding: "10px", fontSize: "24px", height: "45px", width: "45px" }}
                    >
                        <i className="ri-menu-line"></i>
                    </IconButton>
                    <Box sx={{margin: "0px", fontSize: "0px", position: "relative", width: "200px", height: "60px", minWidth: "160px", minHeight: "60px"}}>
                        <Image
                            layout="fill"
                            objectFit="contain"
                            src={APP_LOGO}
                    ...
                    <Box sx={{ flexGrow: 1, display: "flex", justifyContent: "right" }}>
                        ...
                        <Menu
                            ...
                            >
                            <MenuItem>
                                <Avatar sx={{marginRight: "10px", width: 60, height: 60}} alt="Alken Dester" />
                                <Box>
