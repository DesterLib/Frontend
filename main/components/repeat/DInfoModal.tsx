...
const InfoModalBackdrop = styled(Box)(({ theme }) => ({
  width: "100%",
  paddingBottom: "40%",
  position: "relative"
}));

const InfoModalBackdropWrapper = styled(Box)(({ theme }) => ({
    ...
    return (
            ...
            >
                ...
                <Box sx={{marginBottom: "20px"}}>
                  ...
                  <DButton sx={{'& .MuiButton-startIcon': { marginRight: "0px"}}} startIcon={<i className="ri-add-circle-line"></i>} variant="contained" color="secondary"  size="small" />
                </Box>
                <Box>
                ...
                <Box>
                  <Typography variant="subtitle2" gutterBottom>
                      {item.genres && item.genres.map((genre: GenreChipProps) => (
                        <Chip sx={{marginRight: "10px", marginBottom: "10px"}} key={genre.id} label={genre.name} />
                      ))}
                  </Typography>
                </Box>
                </DialogContent>
